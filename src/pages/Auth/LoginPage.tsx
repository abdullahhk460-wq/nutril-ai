...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setError('Email/Password login is not yet configured. Please use Google Sign In.');
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="mt-8 text-4xl font-black tracking-tighter text-slate-900 leading-none">Welcome Back</h2>
        ...
        <div className="space-y-6">
          <Button 
            ...
            isLoading={isLoading}
          >
            <img src="https://www.google.com/favicon.ico" alt="Google" className="w-5 h-5 grayscale opacity-50" />
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="flex justify-end px-1">
                  <button type="button" className="text-[10px] font-black uppercase tracking-widest text-emerald-600 hover:text-emerald-500 transition-colors">
                    Forgot password?
                  </button>
                </div>
              </div>
        ...
        <p className="text-center text-xs font-black uppercase tracking-[0.2em] text-slate-400">
          ...
          <Link to="/register" className="text-emerald-600 hover:text-emerald-500 underline underline-offset-4 decoration-2 transition-all">
            Join the beta
          </Link>
        </p>
      </motion.div>
